...
if (isset($_POST['email']) && isset($_POST['surname']) && isset($_POST['firstname'])) {
  ...
  //Email information
  $admin_email = "opcommander1@hotmail.com";
  ...
  $message = "<p>Surname: ".$surname."</p> <p>First Name: ".$firstname."</p> <p>Email: ".$email."</p> <p>Phone: ".$phone."</p> <p>Address: ".$address."</p> <p>Gender: ".$gender."</p> <p>Age: ".$age."</p>"; 
